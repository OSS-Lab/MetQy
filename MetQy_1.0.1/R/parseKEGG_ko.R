...
#'
#' Read and format the KEGG orthology (KO) database (containing ortholog (gene) information) text file ("\code{KEGG_path}/genes/ko.tar.gz" OR
#' "\code{KEGG_path}/genes/ko/ko") into a reference table.
#'
#' Note that the columns are automatically generated by the \code{parseKEGG_file} function and
#' columns or variables specific to the KEGG ortholog database are further formated.
#'
