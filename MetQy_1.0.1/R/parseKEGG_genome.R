...
#'
#' @param outDir        - optional. String pointing to the output folder. Default ("output/"). \code{NULL} overwrites existing files.
#'
...
parseKEGG_genome <- function(KEGG_path, outDir = "output",addECs = T, addKOs = T,includeViruses = F, verbose = T,...){
