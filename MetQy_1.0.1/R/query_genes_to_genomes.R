#' Find the genome(s) that express a set of genes.
#'
...
#'
#' @examples
#' genomes <- query_genes_to_genome("K00844")
#'
#' genomes <- query_genes_to_genome("1.1.1.1")
#'
#' genomes <- query_genes_to_genome(genes = paste("K0000",1:3,sep=""))
#'
#' @seealso \link{parseKEGG_genome}, \link{ko_reference_table}, \link{enzyme_reference_table}
#' @export

query_genes_to_genome <- function(genes,use_genome_reference_table = NULL,use_ko_reference_table = NULL,use_enzyme_reference_table = NULL){
