...
#'
#' Read and format the KEGG reaction database text file ("\code{KEGG_path}/ligand/reaction.tar.gz" OR
#' "\code{KEGG_path}/ligand/reaction/reaction")
...
#' columns or variables specific to the KEGG reaction database are further formated.
#'
