...
#' that can be used with the function function \code{misc_geneVector_module()}
...
#' The default is to use the column named 'KOs', but it can be names differently and specified in the argument field.
#'
...
#' Data frame used to populate the ahort name in module_reference_table
#'
