...
#'
#' @param data_in     - numeric matrix or 3-column data frame containing the module fraction match of the genomes and modules.
#'
#' @param row_lab     - optional. String to specify the axis label corresponding to the row values. Default ("Genomes").
#'
#' @param col_lab     - optional. String to specify the axis label corresponding to the row values. Default ("Modules").
#'
...
#'
#' @details \code{set_yLim} - #' the default (\code{FALSE}), sets the y limit to \code{c(0, 1)}, while \code{TRUE} to the \code{c(min, max)} of the data.
