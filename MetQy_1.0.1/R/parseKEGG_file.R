...
#'
#' @details
#' File most be decompressed before being processed.
...
#'
#' @seealso \link{parseKEGG_compound},\link{parseKEGG_enzyme},\link{parseKEGG_genome},
#' \link{parseKEGG_module},\link{parseKEGG_reaction}, \link{parseKEGG_execute_all}
#'
#' @export
#'
