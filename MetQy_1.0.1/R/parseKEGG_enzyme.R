...
#'
#' Read the KEGG enzyme database text file ("\code{KEGG_path}/ligand/enzyme.tar.gz" OR "\code{KEGG_path}/ligand/enzyme/enzyme")
...
#' columns or variables specific to the KEGG enzyme database are further formated.
#'
...
#' 	 (4) CLASS_II   - further enzyme class info; refers to the second position (different for every class);
#' 	 (5) CLASS_III  - further enzyme class info; refers to the third  position (different for every class);
